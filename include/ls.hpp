...
LS(double *y,double *x,int nobs,int nvar,double *A,double *b,int nineq)
{
    this->y = y;
    this->x = x;
    this->nobs = nobs;
...
LS(double *y,double *x,int nobs,int nvar,double *A,double *b,int nineq,double *Aeq,double *beq,int neq)
{
    this->y = y;
    this->x = x;
    this->nobs = nobs;
