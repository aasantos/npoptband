...
//
public:
    QP(double *H,double *f,int n,double *A,double *b,int nineq)
    {
        this->n = n;
        this->H = H;
        this->f = f;
    ...
    //
    QP(double *H,double *f,int n,double *A,double *b,int nineq,double *Aeq,double *beq,double neq)
    {
        this->n = n;
        this->H = H;
        this->f = f;
...
private:
    //
    void qptols(double *H,double *f,double *y,double *x,int n)
    {
        int size = n*n;
        chol(H,n);
